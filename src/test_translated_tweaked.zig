...
pub extern fn SDL_DoStuff(...) c_int;
...
pub const ziggy = struct {
    pub const ex = @"-";
    pub const __fsid_t = @"-".__fsid_t;
    pub const __fpclassify = @"-".__fpclassify;
    pub const __signbit = @"-".__signbit;
    pub const __isinf = @"-".__isinf;
    pub const __finite = @"-".__finite;
    pub const __isnan = @"-".__isnan;
    pub const __iseqsig = @"-".__iseqsig;
    pub const __issignaling = @"-".__issignaling;
    pub const acos = @"-".acos;
    pub const __acos = @"-".__acos;
    pub const asin = @"-".asin;
    pub const __asin = @"-".__asin;
    pub const atan = @"-".atan;
    pub const __atan = @"-".__atan;
    pub const atan2 = @"-".atan2;
    pub const __atan2 = @"-".__atan2;
    pub const cos = @"-".cos;
    pub const __cos = @"-".__cos;
    pub const sin = @"-".sin;
    pub const __sin = @"-".__sin;
    pub const tan = @"-".tan;
    pub const __tan = @"-".__tan;
    pub const cosh = @"-".cosh;
    pub const __cosh = @"-".__cosh;
    pub const sinh = @"-".sinh;
    pub const __sinh = @"-".__sinh;
    pub const tanh = @"-".tanh;
    pub const __tanh = @"-".__tanh;
    pub const acosh = @"-".acosh;
    pub const __acosh = @"-".__acosh;
    pub const asinh = @"-".asinh;
    pub const __asinh = @"-".__asinh;
    pub const atanh = @"-".atanh;
    pub const __atanh = @"-".__atanh;
    pub const exp = @"-".exp;
    pub const __exp = @"-".__exp;
    pub const frexp = @"-".frexp;
    pub const __frexp = @"-".__frexp;
    pub const ldexp = @"-".ldexp;
    pub const __ldexp = @"-".__ldexp;
    pub const log = @"-".log;
    pub const __log = @"-".__log;
    pub const log10 = @"-".log10;
    pub const __log10 = @"-".__log10;
    pub const modf = @"-".modf;
    pub const __modf = @"-".__modf;
    pub const expm1 = @"-".expm1;
    pub const __expm1 = @"-".__expm1;
    pub const log1p = @"-".log1p;
    pub const __log1p = @"-".__log1p;
    pub const logb = @"-".logb;
    pub const __logb = @"-".__logb;
    pub const exp2 = @"-".exp2;
    pub const __exp2 = @"-".__exp2;
    pub const log2 = @"-".log2;
    pub const __log2 = @"-".__log2;
    pub const pow = @"-".pow;
    pub const __pow = @"-".__pow;
    pub const sqrt = @"-".sqrt;
    pub const __sqrt = @"-".__sqrt;
    pub const hypot = @"-".hypot;
    pub const __hypot = @"-".__hypot;
    pub const cbrt = @"-".cbrt;
    pub const __cbrt = @"-".__cbrt;
    pub const ceil = @"-".ceil;
    pub const fabs = @"-".fabs;
    pub const floor = @"-".floor;
    pub const fmod = @"-".fmod;
    pub const __fmod = @"-".__fmod;
    pub const isinf = @"-".isinf;
    pub const finite = @"-".finite;
    pub const drem = @"-".drem;
    pub const __drem = @"-".__drem;
    pub const significand = @"-".significand;
    pub const __significand = @"-".__significand;
    pub const copysign = @"-".copysign;
    pub const nan = @"-".nan;
    pub const __nan = @"-".__nan;
    ...
    pub const __yn = @"-".__yn;
    pub const erf = @"-".erf;
    pub const __erf = @"-".__erf;
    pub const erfc = @"-".erfc;
    pub const __erfc = @"-".__erfc;
    pub const lgamma = @"-".lgamma;
    pub const __lgamma = @"-".__lgamma;
    pub const tgamma = @"-".tgamma;
    pub const __tgamma = @"-".__tgamma;
    pub const gamma = @"-".gamma;
    pub const __gamma = @"-".__gamma;
    pub const lgamma_r = @"-".lgamma_r;
    pub const __lgamma_r = @"-".__lgamma_r;
    pub const rint = @"-".rint;
    pub const __rint = @"-".__rint;
    pub const nextafter = @"-".nextafter;
    pub const __nextafter = @"-".__nextafter;
    pub const nexttoward = @"-".nexttoward;
    pub const __nexttoward = @"-".__nexttoward;
    pub const remainder = @"-".remainder;
    pub const __remainder = @"-".__remainder;
    pub const scalbn = @"-".scalbn;
    pub const __scalbn = @"-".__scalbn;
    pub const ilogb = @"-".ilogb;
    pub const __ilogb = @"-".__ilogb;
    pub const scalbln = @"-".scalbln;
    pub const __scalbln = @"-".__scalbln;
    pub const nearbyint = @"-".nearbyint;
    pub const __nearbyint = @"-".__nearbyint;
    pub const round = @"-".round;
    pub const trunc = @"-".trunc;
    pub const remquo = @"-".remquo;
    pub const __remquo = @"-".__remquo;
    pub const lrint = @"-".lrint;
    pub const __lrint = @"-".__lrint;
    pub const llrint = @"-".llrint;
    pub const __llrint = @"-".__llrint;
    pub const lround = @"-".lround;
    pub const __lround = @"-".__lround;
    pub const llround = @"-".llround;
    pub const __llround = @"-".__llround;
    pub const fdim = @"-".fdim;
    pub const __fdim = @"-".__fdim;
    pub const fmax = @"-".fmax;
    pub const fmin = @"-".fmin;
    pub const fma = @"-".fma;
    pub const __fma = @"-".__fma;
    pub const scalb = @"-".scalb;
    pub const __scalb = @"-".__scalb;
    pub const __fpclassifyf = @"-".__fpclassifyf;
    pub const __signbitf = @"-".__signbitf;
    pub const __isinff = @"-".__isinff;
    pub const __finitef = @"-".__finitef;
    pub const __isnanf = @"-".__isnanf;
    pub const __iseqsigf = @"-".__iseqsigf;
    pub const __issignalingf = @"-".__issignalingf;
    pub const acosf = @"-".acosf;
    pub const __acosf = @"-".__acosf;
    pub const asinf = @"-".asinf;
    pub const __asinf = @"-".__asinf;
    pub const atanf = @"-".atanf;
    pub const __atanf = @"-".__atanf;
    pub const atan2f = @"-".atan2f;
    pub const __atan2f = @"-".__atan2f;
    pub const cosf = @"-".cosf;
    pub const __cosf = @"-".__cosf;
    pub const sinf = @"-".sinf;
    pub const __sinf = @"-".__sinf;
    pub const tanf = @"-".tanf;
    pub const __tanf = @"-".__tanf;
    pub const coshf = @"-".coshf;
    pub const __coshf = @"-".__coshf;
    pub const sinhf = @"-".sinhf;
    pub const __sinhf = @"-".__sinhf;
    pub const tanhf = @"-".tanhf;
    pub const __tanhf = @"-".__tanhf;
    pub const acoshf = @"-".acoshf;
    pub const __acoshf = @"-".__acoshf;
    pub const asinhf = @"-".asinhf;
    pub const __asinhf = @"-".__asinhf;
    pub const atanhf = @"-".atanhf;
    pub const __atanhf = @"-".__atanhf;
    pub const expf = @"-".expf;
    pub const __expf = @"-".__expf;
    pub const frexpf = @"-".frexpf;
    pub const __frexpf = @"-".__frexpf;
    pub const ldexpf = @"-".ldexpf;
    pub const __ldexpf = @"-".__ldexpf;
    pub const logf = @"-".logf;
    pub const __logf = @"-".__logf;
    pub const log10f = @"-".log10f;
    pub const __log10f = @"-".__log10f;
    pub const modff = @"-".modff;
    pub const __modff = @"-".__modff;
    pub const expm1f = @"-".expm1f;
    pub const __expm1f = @"-".__expm1f;
    pub const log1pf = @"-".log1pf;
    pub const __log1pf = @"-".__log1pf;
    pub const logbf = @"-".logbf;
    pub const __logbf = @"-".__logbf;
    pub const exp2f = @"-".exp2f;
    pub const __exp2f = @"-".__exp2f;
    pub const log2f = @"-".log2f;
    pub const __log2f = @"-".__log2f;
    pub const powf = @"-".powf;
    pub const __powf = @"-".__powf;
    pub const sqrtf = @"-".sqrtf;
    pub const __sqrtf = @"-".__sqrtf;
    pub const hypotf = @"-".hypotf;
    pub const __hypotf = @"-".__hypotf;
    pub const cbrtf = @"-".cbrtf;
    pub const __cbrtf = @"-".__cbrtf;
    pub const ceilf = @"-".ceilf;
    pub const fabsf = @"-".fabsf;
    pub const floorf = @"-".floorf;
    pub const fmodf = @"-".fmodf;
    pub const __fmodf = @"-".__fmodf;
    pub const isinff = @"-".isinff;
    pub const finitef = @"-".finitef;
    pub const dremf = @"-".dremf;
    pub const __dremf = @"-".__dremf;
    pub const significandf = @"-".significandf;
    pub const __significandf = @"-".__significandf;
    pub const copysignf = @"-".copysignf;
    pub const nanf = @"-".nanf;
    pub const __nanf = @"-".__nanf;
    pub const isnanf = @"-".isnanf;
    pub const j0f = @"-".j0f;
    pub const __j0f = @"-".__j0f;
    pub const j1f = @"-".j1f;
    pub const __j1f = @"-".__j1f;
    pub const jnf = @"-".jnf;
    pub const __jnf = @"-".__jnf;
    pub const y0f = @"-".y0f;
    pub const __y0f = @"-".__y0f;
    pub const y1f = @"-".y1f;
    pub const __y1f = @"-".__y1f;
    pub const ynf = @"-".ynf;
    pub const __ynf = @"-".__ynf;
    pub const erff = @"-".erff;
    pub const __erff = @"-".__erff;
    pub const erfcf = @"-".erfcf;
    pub const __erfcf = @"-".__erfcf;
    pub const lgammaf = @"-".lgammaf;
    pub const __lgammaf = @"-".__lgammaf;
    pub const tgammaf = @"-".tgammaf;
    pub const __tgammaf = @"-".__tgammaf;
    pub const gammaf = @"-".gammaf;
    pub const __gammaf = @"-".__gammaf;
    pub const lgammaf_r = @"-".lgammaf_r;
    pub const __lgammaf_r = @"-".__lgammaf_r;
    pub const rintf = @"-".rintf;
    pub const __rintf = @"-".__rintf;
    pub const nextafterf = @"-".nextafterf;
    pub const __nextafterf = @"-".__nextafterf;
    pub const nexttowardf = @"-".nexttowardf;
    pub const __nexttowardf = @"-".__nexttowardf;
    pub const remainderf = @"-".remainderf;
    pub const __remainderf = @"-".__remainderf;
    pub const scalbnf = @"-".scalbnf;
    pub const __scalbnf = @"-".__scalbnf;
    pub const ilogbf = @"-".ilogbf;
    pub const __ilogbf = @"-".__ilogbf;
    pub const scalblnf = @"-".scalblnf;
    pub const __scalblnf = @"-".__scalblnf;
    pub const nearbyintf = @"-".nearbyintf;
    pub const __nearbyintf = @"-".__nearbyintf;
    pub const roundf = @"-".roundf;
    pub const truncf = @"-".truncf;
    pub const remquof = @"-".remquof;
    pub const __remquof = @"-".__remquof;
    pub const lrintf = @"-".lrintf;
    pub const __lrintf = @"-".__lrintf;
    pub const llrintf = @"-".llrintf;
    pub const __llrintf = @"-".__llrintf;
    pub const lroundf = @"-".lroundf;
    pub const __lroundf = @"-".__lroundf;
    pub const llroundf = @"-".llroundf;
    pub const __llroundf = @"-".__llroundf;
    pub const fdimf = @"-".fdimf;
    pub const __fdimf = @"-".__fdimf;
    pub const fmaxf = @"-".fmaxf;
    pub const fminf = @"-".fminf;
    pub const fmaf = @"-".fmaf;
    pub const __fmaf = @"-".__fmaf;
    pub const scalbf = @"-".scalbf;
    pub const __scalbf = @"-".__scalbf;
    pub const __fpclassifyl = @"-".__fpclassifyl;
    pub const __signbitl = @"-".__signbitl;
    pub const __isinfl = @"-".__isinfl;
    pub const __finitel = @"-".__finitel;
    pub const __isnanl = @"-".__isnanl;
    pub const __iseqsigl = @"-".__iseqsigl;
    pub const __issignalingl = @"-".__issignalingl;
    pub const acosl = @"-".acosl;
    pub const __acosl = @"-".__acosl;
    pub const asinl = @"-".asinl;
    pub const __asinl = @"-".__asinl;
    pub const atanl = @"-".atanl;
    pub const __atanl = @"-".__atanl;
    pub const atan2l = @"-".atan2l;
    pub const __atan2l = @"-".__atan2l;
    pub const cosl = @"-".cosl;
    pub const __cosl = @"-".__cosl;
    pub const sinl = @"-".sinl;
    pub const __sinl = @"-".__sinl;
    pub const tanl = @"-".tanl;
    pub const __tanl = @"-".__tanl;
    pub const coshl = @"-".coshl;
    pub const __coshl = @"-".__coshl;
    pub const sinhl = @"-".sinhl;
    pub const __sinhl = @"-".__sinhl;
    pub const tanhl = @"-".tanhl;
    pub const __tanhl = @"-".__tanhl;
    pub const acoshl = @"-".acoshl;
    pub const __acoshl = @"-".__acoshl;
    pub const asinhl = @"-".asinhl;
    pub const __asinhl = @"-".__asinhl;
    pub const atanhl = @"-".atanhl;
    pub const __atanhl = @"-".__atanhl;
    pub const expl = @"-".expl;
    pub const __expl = @"-".__expl;
    pub const frexpl = @"-".frexpl;
    pub const __frexpl = @"-".__frexpl;
    pub const ldexpl = @"-".ldexpl;
    pub const __ldexpl = @"-".__ldexpl;
    pub const logl = @"-".logl;
    pub const __logl = @"-".__logl;
    pub const log10l = @"-".log10l;
    pub const __log10l = @"-".__log10l;
    pub const modfl = @"-".modfl;
    pub const __modfl = @"-".__modfl;
    pub const expm1l = @"-".expm1l;
    pub const __expm1l = @"-".__expm1l;
    pub const log1pl = @"-".log1pl;
    pub const __log1pl = @"-".__log1pl;
    pub const logbl = @"-".logbl;
    pub const __logbl = @"-".__logbl;
    pub const exp2l = @"-".exp2l;
    pub const __exp2l = @"-".__exp2l;
    pub const log2l = @"-".log2l;
    pub const __log2l = @"-".__log2l;
    pub const powl = @"-".powl;
    pub const __powl = @"-".__powl;
    pub const sqrtl = @"-".sqrtl;
    pub const __sqrtl = @"-".__sqrtl;
    pub const hypotl = @"-".hypotl;
    pub const __hypotl = @"-".__hypotl;
    pub const cbrtl = @"-".cbrtl;
    pub const __cbrtl = @"-".__cbrtl;
    pub const ceill = @"-".ceill;
    pub const fabsl = @"-".fabsl;
    pub const floorl = @"-".floorl;
    pub const fmodl = @"-".fmodl;
    pub const __fmodl = @"-".__fmodl;
    pub const isinfl = @"-".isinfl;
    pub const finitel = @"-".finitel;
    pub const dreml = @"-".dreml;
    pub const __dreml = @"-".__dreml;
    pub const significandl = @"-".significandl;
    pub const __significandl = @"-".__significandl;
    pub const copysignl = @"-".copysignl;
    pub const nanl = @"-".nanl;
    pub const __nanl = @"-".__nanl;
    pub const isnanl = @"-".isnanl;
    pub const j0l = @"-".j0l;
    pub const __j0l = @"-".__j0l;
    pub const j1l = @"-".j1l;
    pub const __j1l = @"-".__j1l;
    pub const jnl = @"-".jnl;
    pub const __jnl = @"-".__jnl;
    pub const y0l = @"-".y0l;
    pub const __y0l = @"-".__y0l;
    pub const y1l = @"-".y1l;
    pub const __y1l = @"-".__y1l;
    pub const ynl = @"-".ynl;
    pub const __ynl = @"-".__ynl;
    pub const erfl = @"-".erfl;
    pub const __erfl = @"-".__erfl;
    pub const erfcl = @"-".erfcl;
    pub const __erfcl = @"-".__erfcl;
    pub const lgammal = @"-".lgammal;
    pub const __lgammal = @"-".__lgammal;
    pub const tgammal = @"-".tgammal;
    pub const __tgammal = @"-".__tgammal;
    pub const gammal = @"-".gammal;
    pub const __gammal = @"-".__gammal;
    pub const lgammal_r = @"-".lgammal_r;
    pub const __lgammal_r = @"-".__lgammal_r;
    pub const rintl = @"-".rintl;
    pub const __rintl = @"-".__rintl;
    pub const nextafterl = @"-".nextafterl;
    pub const __nextafterl = @"-".__nextafterl;
    pub const nexttowardl = @"-".nexttowardl;
    pub const __nexttowardl = @"-".__nexttowardl;
    pub const remainderl = @"-".remainderl;
    pub const __remainderl = @"-".__remainderl;
    pub const scalbnl = @"-".scalbnl;
    pub const __scalbnl = @"-".__scalbnl;
    pub const ilogbl = @"-".ilogbl;
    pub const __ilogbl = @"-".__ilogbl;
    pub const scalblnl = @"-".scalblnl;
    pub const __scalblnl = @"-".__scalblnl;
    pub const nearbyintl = @"-".nearbyintl;
    pub const __nearbyintl = @"-".__nearbyintl;
    pub const roundl = @"-".roundl;
    pub const truncl = @"-".truncl;
    pub const remquol = @"-".remquol;
    pub const __remquol = @"-".__remquol;
    pub const lrintl = @"-".lrintl;
    pub const __lrintl = @"-".__lrintl;
    pub const llrintl = @"-".llrintl;
    pub const __llrintl = @"-".__llrintl;
    pub const lroundl = @"-".lroundl;
    pub const __lroundl = @"-".__lroundl;
    pub const llroundl = @"-".llroundl;
    pub const __llroundl = @"-".__llroundl;
    pub const fdiml = @"-".fdiml;
    pub const __fdiml = @"-".__fdiml;
    pub const fmaxl = @"-".fmaxl;
    pub const fminl = @"-".fminl;
    pub const fmal = @"-".fmal;
    pub const __fmal = @"-".__fmal;
    pub const scalbl = @"-".scalbl;
    pub const __scalbl = @"-".__scalbl;
    pub const __fpclassifyf128 = @"-".__fpclassifyf128;
    pub const __signbitf128 = @"-".__signbitf128;
    pub const __isinff128 = @"-".__isinff128;
    pub const __finitef128 = @"-".__finitef128;
    pub const __isnanf128 = @"-".__isnanf128;
    pub const __iseqsigf128 = @"-".__iseqsigf128;
    pub const __issignalingf128 = @"-".__issignalingf128;
    pub const SDL_DoStuff = @"-".SDL_DoStuff;
    pub const struct_SDL_Data = @"-".struct_SDL_Data;
};
